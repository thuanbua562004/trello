...
export default function Header() {
  ...
  return (
    <>
      ...
      <div className="header flex justify-between h-[50px] w-full bg-white px-2">
        ...
        <div onClick={toggleMenu} className="action flex items-center w-3/12 justify-end relative">
          <div className="w-8 h-8 hover:bg-gray-200 flex items-center justify-center rounded-lg">
            <img
